...
const ROLE_ALLOWED_VIEWS = {
  admin: ['dashboard', 'manage_staff', 'admin_beds', 'financials'],
  doctor: ['dashboard', 'doctor_queue', 'doctor_records'],
  reception: ['dashboard', 'reception_booking', 'reception_billing', 'reception_beds'],
  patient: ['dashboard', 'patient_book', 'patient_history', 'patient_billing']
};
